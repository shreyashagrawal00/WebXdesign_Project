...
// Use relative path when served by backend (port 5001), or fallback to localhost:5001 for dev (e.g. port 5173)
const isProduction = window.location.port === '5001';
const API_URL = isProduction ? '/api' : 'http://localhost:5001/api';
const socket = isProduction ? io() : io('http://localhost:5001');
